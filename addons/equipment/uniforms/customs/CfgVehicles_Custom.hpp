    ...
    class aux187_Custom_Hesh : aux187_P2_Base
	{
		...
		hiddenSelectionsTextures[] = { QPATHTOF(uniforms\customs\data\187th_Uniform_Hesh_Torso.paa), QPATHTOF(uniforms\customs\data\187th_Uniform_Hesh_Legs.paa) };
	};

    class aux187_Custom_Horizon : 3AS_Rep_Commando_F
	{
		scope = 1;
		uniformClass = "aux187_Uniform_Custom_Horizon";
    ...
    class aux187_Custom_Lord : aux187_P2_Base
	{
		...
		hiddenSelectionsTextures[] = { QPATHTOF(uniforms\customs\data\187th_Uniform_Lord_Torso.paa), QPATHTOF(uniforms\customs\data\187th_Uniform_Lord_Legs.paa) };
	};

    class aux187_Custom_Mindless : 3AS_Rep_Commando_F
	{
		scope = 1;
		uniformClass = "aux187_Uniform_Custom_Mindless";
	...
	{
		scope = 1;
		uniformClass = "aux187_Uniform_Custom_Ringer";
	...
	class aux187_Custom_Carmine : aux187_P2_Base
	{
		scope = 1;
		uniformClass = "aux187_Uniform_Custom_Carmine";
		
		hiddenSelectionsTextures[] = { QPATHTOF(uniforms\customs\data\187th_Uniform_Carmine_Torso.paa), QPATHTOF(uniforms\customs\data\187th_Uniform_Carmine_Legs.paa) };
	};
