    ...
    class aux187_BTLB_Y_Wing : 3AS_BTLB_Bomber
    {
        displayName = "BTL/B Y-Wing";

        hiddenSelectionsTextures[] = 
        { 
            QPATHTOF(ywing\data\187th_BTLB_Default_Chassis_CO.paa),
        ...
        textureList[] = {"aux187_YWing_Texture_Default", 1};

        class ACE_SelfActions : ACE_SelfActions
        {
            class aux187_YWing_Skins
            {
                ...
                class aux187_YWing_Skin_Default
                {
                    displayName = "Default";
                    statement = "(vehicle player) setObjectTextureGlobal [0,'z\aux187\addons\aircraft\ywing\data\187th_BTLB_Default_Chassis_CO.paa']; (vehicle player) setObjectTextureGlobal[1,'3as\3AS_btlb\data\detail_co.paa']; (vehicle player) setObjectTextureGlobal[2,'3as\3AS_btlb\data\interior_co.paa']; (vehicle player) setObjectTextureGlobal[3,'#(argb,8,8,3)color(0.75,0.75,0.75,1,ca)'];";
                };
            };
        ...
        {
            class aux187_YWing_Texture_Default
            {
                displayName = "Default";
                author = "187th Legion";
                textures[] = 
