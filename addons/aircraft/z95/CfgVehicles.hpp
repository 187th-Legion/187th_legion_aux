    ...
    class aux187_Z95 : 3AS_Z95_Republic
    {
        displayName = "Z-95 HeadHunter";

        hiddenSelectionsTextures[] = 
        { 
            QPATHTOF(z95\data\187th_Z95_Default_Body_CO.paa),
        ...
        textureList[] = {"aux187_Z95_Texture_Default", 1};

        class ACE_SelfActions : ACE_SelfActions
        {
            class aux187_Z95_Skins
            {
                ...
                {
                    displayName = "Default";
                    statement = "(vehicle player) setObjectTextureGlobal [0,'z\aux187\addons\aircraft\z95\data\187th_Z95_Default_Body_CO.paa']; (vehicle player) setObjectTextureGlobal[1,'3AS\3AS_Z95\Data\cockpit_co.paa']; (vehicle player) setObjectTextureGlobal[2,'3AS\3AS_Z95\data\glass\glass_ca'];";
                };
            };
        ...
        {
            class aux187_Z95_Texture_Default
            {
                displayName = "Default";
                author = "187th Legion";
                textures[] = 
